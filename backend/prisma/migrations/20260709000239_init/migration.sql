...
-- CreateEnum
CREATE TYPE "WarrantyType" AS ENUM ('MANUFACTURER', 'EXTENDED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('REMINDER', 'PAYMENT', 'SUBSCRIPTION', 'SYSTEM');
...
-- AddForeignKey
ALTER TABLE "Invoice" ADD CONSTRAINT "Invoice_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
