...
import { claimStatuses, type AssetDocument, type Claim, type ClaimInput, type ClaimStatus, type ClaimUpdate } from "@/lib/claims-api";
...
export function ClaimFormModal({ claim, assets, documents, pending, initialAssetId = "", onAssetChange, onClose, onSubmit }: Props) {
  ...
  return <div className="fixed inset-0 z-[70] flex items-center justify-center bg-[#111827]/45 p-4 sm:p-6" role="dialog" aria-modal="true">
    <div className="max-h-[94vh] w-full max-w-2xl overflow-y-auto rounded-l-2xl bg-[#f8f9ff] shadow-2xl">
