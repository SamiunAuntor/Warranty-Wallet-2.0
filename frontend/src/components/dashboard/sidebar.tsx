...
const items = [["dashboard", "Dashboard", "/dashboard"], ["products", "Assets", "/dashboard/assets"], ["claims", "Claims", "/dashboard/claims"], ["clipboard", "Billing", "/dashboard/billing"]] as const;
