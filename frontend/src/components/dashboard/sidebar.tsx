...
const items = [
  ["dashboard", "Dashboard", "/dashboard"], ["products", "Assets", "/dashboard/assets"], ["claims", "Claims", "/dashboard/claims"], ["documents", "Documents", "/dashboard/documents"], ["insights", "Insights", "/dashboard/insights"],
] as const;
