  ...
  return <div className="fixed inset-0 z-[70] flex items-center justify-center bg-[#111827]/45 p-4 sm:p-6" role="dialog" aria-modal="true" aria-labelledby="asset-upload-title">
    <div className="max-h-[94vh] w-full max-w-3xl overflow-hidden rounded-l-2xl bg-[#f8f9ff] shadow-2xl">
      ...
      <div className="space-y-5 p-6">
        ...
        {extracting && <div className="flex items-center gap-3 rounded-lg bg-[#eeecff] px-4 py-3 text-sm text-[#4b41e1]"><span className="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#e8e4ff]"><span className="absolute left-1/2 top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rotate-45 rounded-sm bg-[#4b41e1] before:absolute before:-left-0.5 before:top-1/2 before:h-1.5 before:w-1.5 before:-translate-y-1/2 before:rounded-full before:bg-[#4b41e1] before:content-[''] after:absolute after:left-1/2 after:-top-0.5 after:h-1.5 after:w-1.5 after:-translate-x-1/2 after:rounded-full after:bg-[#4b41e1] after:content-['']"/><span className="absolute right-0 top-0 h-2 w-2 rounded-full bg-[#cfcfcf]"/></span><span>Analyzing document {Math.min(processedCount + 1, documents.length)} of {documents.length}...</span></div>}
