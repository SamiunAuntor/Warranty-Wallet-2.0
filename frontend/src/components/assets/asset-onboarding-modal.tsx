  ...
  return <div className="fixed inset-0 z-[70] flex items-center justify-center bg-[#111827]/45 p-4 sm:p-6" role="dialog" aria-modal="true" aria-labelledby="asset-upload-title">
    <div className="max-h-[94vh] w-full max-w-3xl overflow-hidden rounded-l-2xl bg-[#f8f9ff] shadow-2xl">
      ...
      <div className="space-y-5 p-6">
        ...
        {extracting && <div className="flex items-center gap-3 rounded-lg bg-[#eeecff] px-4 py-3 text-sm text-[#4b41e1]"><span className="scan-line relative flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[#e8e4ff]"><span className="absolute left-1/2 top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 rotate-45 rounded-sm bg-[#1f1f1f] before:absolute before:-left-1 before:top-1/2 before:h-2 before:w-2 before:-translate-y-1/2 before:rounded-full before:bg-[#1f1f1f] before:content-[''] after:absolute after:left-1/2 after:-top-1 after:h-2 after:w-2 after:-translate-x-1/2 after:rounded-full after:bg-[#1f1f1f] after:content-['']"/><span className="absolute right-1 top-1 h-2 w-2 rounded-full bg-[#cfcfcf]"/></span><span>Analyzing document {Math.min(processedCount + 1, documents.length)} of {documents.length}...</span></div>}
