...
export function AssetDetailsModal({ asset, onClose, onEdit, onDelete }: Props) {
  const rows = [
    ...
    ["Warranty type", asset.warrantyType === "EXTENDED" ? "Extended" : "Manufacturer"],
