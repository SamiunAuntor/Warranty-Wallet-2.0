      ...
      <section className="relative flex w-full items-center justify-center px-5 py-10 sm:px-10 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="space-y-1.5"><label htmlFor="full-name" className="text-xs font-semibold text-[#45464d]">Full Name</label><input id="full-name" name="name" required autoComplete="name" type="text" placeholder="John Doe" className={inputClass}/></div>
            <div className="space-y-1.5"><label htmlFor="register-email" className="text-xs font-semibold text-[#45464d]">Email Address</label><input id="register-email" name="email" required autoComplete="email" type="email" placeholder="name@company.com" className={inputClass}/></div>
            ...
            <label className="flex items-start gap-2 text-xs text-[#45464d]"><input name="terms" type="checkbox" className="mt-0.5 h-4 w-4 rounded border-[#c6c6cd] accent-[#4b41e1]"/><span>I agree to the <Link href="#" className="font-medium text-[#4b41e1]">Terms of Service</Link> and <Link href="#" className="font-medium text-[#4b41e1]">Privacy Policy</Link>.</span></label>
