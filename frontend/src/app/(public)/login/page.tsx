      ...
      <section className="relative flex w-full items-center justify-center px-5 py-10 sm:px-10 lg:w-1/2">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button disabled={submitting} type="submit" className="flex w-full items-center justify-center gap-2 rounded-lg bg-black px-5 py-3.5 text-sm font-semibold text-white shadow-md transition hover:bg-[#131b2e] active:scale-[.98] disabled:cursor-not-allowed disabled:opacity-60">{submitting ? "Signing in..." : "Sign In"} {!submitting && <Icon name="arrow" className="h-4 w-4"/>}</button>
          </form>
