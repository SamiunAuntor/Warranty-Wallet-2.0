...
export default function AppLayout() {
  ...
  return <Tabs screenOptions={{ headerShown: false, tabBarActiveTintColor: colors.brand }}>
    ...
    <Tabs.Screen name="admin-catalog" options={{ title: "Catalog", tabBarIcon: () => <Text>K</Text> }} />
    <Tabs.Screen name="admin-operations" options={{ title: "Operations", tabBarIcon: () => <Text>X</Text> }} />
